...
const divContainersHeader = document.querySelector('.container-ul-header');
const divFromContainerGeneral = document.querySelector('.form-container-general');
const articleTrendingList = document.querySelector('.trendingPreview-movieList');
const previewArticleCategoriesList = document.querySelector('.categoriesPreview-list')
const divMovieContainer = document.querySelector('.movie-container');
const articleCategoriesList = document.querySelector('.categories-list')
...
const spanMovieDetails = document.querySelector('.movieDetail-score');
const parrafoMovieDetails = document.querySelector('.movieDetail-description');
const spanDateReleaseDetails = document.querySelector('.release-date');
const headerUlGeneral = document.querySelectorAll('.Preview-title a');
const divConatinerLong = document.querySelector('.header-container--long');
...
const trailerButton = document.querySelector('.boton-trailer');
